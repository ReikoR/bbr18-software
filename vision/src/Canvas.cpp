...
const unsigned char Canvas::font[256][8] = {
...
void Canvas::setPixelAt(int x, int y, int red, int green, int blue) {
    if (data == NULL) {
        return;
    }
...
void Canvas::fillBox(int x, int y, int width, int height, int red, int green, int blue) {
    if (data == NULL) {
        return;
    }
...
void Canvas::drawCircle(int centerX, int centerY, int radius, int red, int green, int blue) {
	int x = radius, y = 0;
	int radiusError = 1 - x;
...
void Canvas::fillCircle(int centerX, int centerY, int radius, int red, int green, int blue) {
	if (data == NULL) {
        return;
    }
...
void Canvas::drawChar(int imageX, int imageY, int index, int red, int green, int blue) {
	if (data == NULL) {
        return;
    }
...
void Canvas::drawLine(int x1, int y1, int x2, int y2, int red, int green, int blue) {
	if (data == NULL) {
        return;
    }
...
void Canvas::drawMarker(int x, int y, int red, int green, int blue, bool tiny) {
	if (data == NULL) {
        return;
    }
